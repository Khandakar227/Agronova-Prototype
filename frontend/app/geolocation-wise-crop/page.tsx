        ...
        <div
          className={`fixed top-20 right-0 ${
            suitabilityVisible
              ...
              : "w-16 h-16 bg-green-500 dark:bg-dark rounded-l-full"
          }`}
          style={{
...
{weather && (
  <div
    className={`fixed top-20 left-0  ${
      weatherVisible ? "w-80 p-6 bg-white dark:bg-less-dark dark:text-gray-200 shadow-lg rounded-r-lg" : "w-16 h-16 bg-green-500 dark:bg-dark rounded-r-full"
    }`}
    style={{
